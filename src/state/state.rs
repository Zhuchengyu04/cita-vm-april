    ...
    pub fn commit(&mut self) -> Result<(), Error> {
        ...
        let l = 1;
         ...
         for (key, value) in key_values.into_iter() {
             ...
             let strs = format!("{}{}", String::from_utf8_lossy(key.clone()), String::from_utf8_lossy(value.clone()));
         ...
         for received in rx {
             ...
             info!("{}",&all_sub_commitment[received.0]);
         }
         ...
         info!("all:{:?}",String::from_utf8(res.to_vec()));
